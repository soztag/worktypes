...
```{r imputed-diary-byhrs, fig.cap="Select Imputed Activity Diaries, Scaled to Weekly Hours", include = FALSE}
g <- ggplot(data = diaries_sample, mapping = aes(
  x = respondent,
  y = percent * hours,
  fill = activity))
...
```{r paran2, fig.cap = "Scree Plot with 1000 Simulated Runs, 50th, 95th and 99th Percentile (pcaPA)", autodep = FALSE}

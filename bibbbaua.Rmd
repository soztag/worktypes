...
if (!(pensieve:::assert_n_infer_use_js(use_js = NULL))) {
  plot(g)
} else {
...
We will also be relying on the (effective) working hours in some of the below calculations, so a look at their distribution is 

```{r freq-hours, fig.cap="Raw and Weighted Working Hours"}

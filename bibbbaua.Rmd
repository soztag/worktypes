...
```{r pcares, include = FALSE, eval = FALSE}
pcarot <- psych::principal(r = polies$correlations,
                           nfactors = 2,
                           residuals = FALSE,
                           rotate = "varimax")
pcarot <- pcaPA::PA(dataMatrix = as.data.frame(act[,1:16]),
                    )
FactoMineR::PCA()
factoextra::fviz_pca_biplot(pcarot)
```
...
```{r fares, include = FALSE, eval = FALSE}
fares <- psych::fa(r = as.data.frame(act[,1:16]),
                   nfactors = 2,
                   rotate = "varimax",
                   scores = "regression",
                   covar = FALSE,
